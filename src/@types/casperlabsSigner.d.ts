interface CasperLabsHelper {
   ...
   *
   * @param deployJson the Deploy in the JSON format.
   * @param publicKeyHex the hex encoded public key used to sign the deploy, if set, we will check whether it is the same as the active key.
   */
  sign: (deployJson: any, publicKeyHex: string) => Promise<any>;
